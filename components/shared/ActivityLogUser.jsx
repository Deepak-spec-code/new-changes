...
const ladder_id = useSelector((state)=> state.user?.user?.ladder_id)
    ...
    return activities.map((activity, index) => {
      ...
      return (
        <motion.div
          ...
          className="mb-4 p-4 bg-white rounded-xl shadow-md transition duration-200"
        >
  ...
  return (
    ...
    >
      <Card className="flex items-center justify-center sm:mx-4 border-none bg-gray-800">
