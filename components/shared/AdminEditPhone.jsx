...
const AdminEditPhone = () => {
  ...
  return (
    <div className="w-full p-4 sm:p-6 lg:p-8">
      <h2 className="font-semibold text-white text-lg sm:text-xl text-center sm:text-left mb-4">
        Admin Contact
      </h2>
      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full">
        ...
        <div className="flex flex-col flex-1">
          <label className="font-semibold text-zinc-300  mb-1 text-sm sm:text-base">
            Full Name
          </label>
          <Input
            type="text"
            ...
            className="h-10 text-zinc-200 rounded-lg shadow-lg border-2 border-violet-300 px-3 text-sm sm:text-base"
        ...
        <div className="flex w-full lg:w-auto justify-center lg:items-end">
          <Button
            onClick={handleEdit}
            disabled={loading}
            className="w-full sm:w-32 h-10 mt-2 sm:mt-0 border border-gray-600 shadow-md cursor-pointer transition-all text-white bg-blue-900 hover:bg-blue-950 rounded-lg font-semibold text-lg"
          >
