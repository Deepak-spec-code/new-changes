...
export default function DummyPlayerList({ ladderId }) {
  ...
  // 🧩 Filter players for ladder display
  const filteredPlayers = players
    .filter((p) =>
  ...
  return (
    <div className="px-2">
      ...
      {/* 🔹 Stats Modal with search box inside */}
      <AnimatePresence>
        {isStatsModalOpen && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              {/* 🔹 Search box now INSIDE the modal */}
              <div className="mb-4 flex justify-center">
                <Input
                  ...
                  className="w-full sm:w-96 border-2 border-gray-400 rounded-md px-3 py-2 text-gray-700 focus:border-blue-600 focus:ring-2 focus:ring-blue-300 outline-none"
                />
              </div>
                    ...
                    .map((player, index) => (
                      ...
                      >
                        ...
                        <span>
                          Win %{" "}
                          {(
                            (player?.total_win / player?.total_game) *
                            100
                          ).toFixed(0)}
                          %
                        </span>
