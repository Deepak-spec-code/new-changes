...
//     >
//       <Card className="w-[380px] sm:w-full lg:max-w-md sm:max-w-md md:max-w-md ">
...
//               </Button>
//             </DialogTrigger>
//             <DialogContent className="sm:max-w-xl rounded-2xl shadow-lg">
//               <DialogHeader>
//                 <DialogDescription className="space-y-2 text-sm sm:text-base">
//                   <div className="text-black">
//                     <p className="font-semibold text-center sm:text-start flex gap-2 items-center">
//                       <LiaHandPointRight /> Your score points on this basis
//                     </p>
//                     <br />
...
//                     <br />
//                     <br />
//                     <p className="italic sm:text-start text-center font-semibold text-sm  ">
...
//                     <br />
//                     <p className="text-red-600 italic flex gap-2 items-center">
//                       Your “average points per match” is your Playing Performance
//                     </p>
//                     <br />
//                     <p className="underline text-center">
//                       Your “Playing Performance” is then ranked
...
//                 <TableHeader>
//                   <TableRow>
//                     <TableHead className="text-gray-200">Games</TableHead>
...
//                     <TableHead className="text-gray-200">Avg.Points</TableHead>
//                     <TableHead className="text-gray-200">Rank</TableHead>
//                   </TableRow>
//                 </TableHeader>
//                 <TableBody>
//                   <motion.tr
