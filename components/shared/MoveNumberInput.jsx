...
//     <motion.div
//       layout
//       className="sm:px-8 sm:py-4 p-4 bg-gray-800 rounded-xl shadow-md max-w-md mx-auto"
//     >
//       <h3 className="mb-3 text-sm font-semibold text-center py-2 text-gray-100">
//         Enter the rank of the player you challenged
//       </h3>

//       {/* ✅ Beat / Lost Selection */}
//       <div className="mb-2">
//         <p className="text-sm font-medium text-white">Please Select First :</p>
//       </div>
...
//         className={`mb-4 text-center font-mono text-lg tracking-wide rounded-lg ${isCancelled && !selectedNumber ? "line-through text-gray-100" : ""
//           }`}
//       />

//       <div className="grid grid-cols-3 text-gray-800 gap-2 mb-4">
...
//         <Button variant="outline" onClick={handleBackspace} className="flex-1 text-gray-800">
...
const MoveNumberInput = ({
  ...
  // ✅ Handle Enter logic from first code (without toast)
  const handleEnter = () => {
    ...
    if ((ladderType === "best3" || ladderType === "best5") && !score) return;

    setShowConfirm(true);
  };

  // ✅ Confirm move (fully from first code)
  const confirmMove = async () => {
    try {
      onClose();
      setLoading(true);
    ...
    >
      ...
      <Input
        ...
        className={`mb-4 text-center font-mono text-lg tracking-wide rounded-lg ${
          isCancelled && !selectedNumber
            ? "line-through text-gray-100"
            : ""
        }`}
      />
