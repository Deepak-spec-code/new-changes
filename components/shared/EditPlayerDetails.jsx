...
const EditPlayerDetails = ({ initialData = {}, onClose = () => {} }) => {
  ...
  return (
    <Card className="max-w-md mx-auto mt-6 shadow-xl rounded-2xl bg-gray-800">
      <CardContent className="p-6 space-y-4">
        ...
        {showSkeleton ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="name" className="text-gray-300 font-semibold py-2 text-lg">Name</Label>
              <Input
                id="name"
                name="name"
                value={form.name}
            ...
            <div>
              <Label htmlFor="phone" className="text-gray-300 font-semibold py-2 text-lg">Phone Number</Label>
              <Input
                id="phone"
                name="phone"
                type="tel"
