    ...
    <div className="w-full backdrop-blur-sm ">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full text-white bg-gradient-to-r from-[#114153] to-blue-800">
          <div className="flex flex-col sm:flex-row items-center rounded w-full sm:w-auto py-3 sm:py-0 ">
               <span className="sm:text-sm text-center sm:text-left font-semibold w-full sm:w-auto px-2">
          Ladder URL
        </span>
            <input
              type="text"
              value={registerUrl}
              readOnly
              className="text-sm text-center px-3 py-2 rounded-md flex-1  font-semibold outline-none w-full sm:w-auto "
            />
            <Button
              onClick={handleCopy}
              className="mt-2 sm:mt-0 sm:ml-2 sm:bg-white/0 text-red-200 cursor-pointer px-4 py-2 sm:border-none md:border-none lg:border-none border border-red-400 shadow-md bg-red-100 flex items-center justify-center gap-1 text-sm font-medium w-50 sm:w-auto"
            >
              {copied ? "Copied!" : "Copy"}
              <Copy size={14} />
            </Button>
