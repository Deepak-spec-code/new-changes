...
const PlayerHeading = ({ demoLadderName }) => {
  ...
  return (
    <div className="px-4 w-full">
      <div className="flex flex-col text-zinc-200 sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-4 sm:gap-8 text-center sm:text-left max-w-3xl mx-auto">
        {/* Hidden File Input */}
        <input
          type="file"
          accept="image/*"
